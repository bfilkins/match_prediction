HTML(
  ...
  .js-irs-0 .irs-single, .js-irs-0 .irs-bar-edge, .js-irs-0 .irs-bar {background: ',detail_color, '; border-top: 1px solid ',detail_color, ' ; border-bottom: 1px solid ',detail_color, ' ;}
